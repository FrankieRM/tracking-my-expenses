...
public class NotificationResourceIT {
    ...
    private static final Integer DEFAULT_BEFORE_DAYS = 1;
    private static final Integer UPDATED_BEFORE_DAYS = 2;
    ...
    public static Notification createEntity(EntityManager em) {
        Notification notification = new Notification()
            ...
            .beforeDays(DEFAULT_BEFORE_DAYS);
        return notification;
    }
    /**
    ...
    public static Notification createUpdatedEntity(EntityManager em) {
        Notification notification = new Notification()
            ...
            .beforeDays(UPDATED_BEFORE_DAYS);
        return notification;
    }
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.isSameDay()).isEqualTo(DEFAULT_SAME_DAY);
        assertThat(testNotification.getBeforeDays()).isEqualTo(DEFAULT_BEFORE_DAYS);
    }
    ...
    public void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].beforeDays").value(hasItem(DEFAULT_BEFORE_DAYS)));
    }
    ...
    public void getNotification() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications/{id}", notification.getId()))
            ...
            .andExpect(jsonPath("$.beforeDays").value(DEFAULT_BEFORE_DAYS));
    }
    ...
    public void updateNotification() throws Exception {
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.isSameDay()).isEqualTo(UPDATED_SAME_DAY);
        assertThat(testNotification.getBeforeDays()).isEqualTo(UPDATED_BEFORE_DAYS);
    }
